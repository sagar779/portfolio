...
const Project = ({ title, type, img, link, github }) => {
    return (
        <article className='w-full flex felx-col item-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative '>
...
' />
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                <span className='pt-4 text-primary font-medium text-xl'>{type}</span>
                <Link
                    href={link}
                    target='_blank'
...
const projects = () => {
    return (
        <>
            ...
            <main className='w-full mb-16 flex felx-col item-center justify-center'>
