...
import artical2 from "../../public/images/articles/create loading screen in react js.jpg";
import { motion, useMotionValue } from "framer-motion"
import artical3 from "../../public/images/articles/create modal component in react using react portals.png";
...
const MovingImg = ({ title, img, link }) => {
    ...
    function handleMouse(event){
        imgRef.current.style.display ="initial-block";
        x.set(event.pagex);
        y.set(-10);
    }
    function handleMouseLevel(event){
    ...
    return (
        ...
        >
            ...
            whileInView={{opacity:1, transition:{duration:0.2}}}
             ref={imgRef} src={img} alt={title} className='z-10 w-96 h-auto absolute rounded-lg'/>
        </Link>

    )
}

const Artical = ({ img, title, date, link }) => {
    return (
        <motion.li
        initial={{y:200}}
...
' />
            ...
            >
                <FramerImage src={img} alt={title} className="w-full h-40 "
        ...
        <>
            ...
            <main className='w-full mb-15 flex flex-col items-center justify-center overflow-hidden'>
                <Layout className='pt-16'>
                    ...
                    <h2 className='font-bold text-4xl w-full text-center my-16 mt-32'>All Articals</h2>
                    <ul>
                        <Artical
